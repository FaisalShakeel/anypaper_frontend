...
import { Assignment, Edit, InsertDriveFile, InsertDriveFileOutlined, Logout, RateReview } from "@mui/icons-material";
...
const EditorDashboardLayout = ({ children }) => {
  ...
  const getSelectedOption = () => {
    ...
    if (path.includes("/editor/dashboard")) return "Dashboard";
    if (path.includes("/editor/assigned-orders")) return "My Orders";
    if (path.includes("/editor/chat")) return "Chat";
    if (path.includes("/editor/my-writers")) return "My Writers";
    if (path.includes("/editor/my-files")) return "My Files";
  ...
  const handleMenuItemClick = (text) => {
    ...
    switch (text) {
      case "My Orders":
        navigate("/editor/assigned-orders");
        break;
      case "Chat":
        navigate("/editor/chat");
        break;
      case "Dashboard":
        navigate("/editor/dashboard");
        break;
      case "My Writers":
        navigate("/editor/my-writers");
        break;
      case "My Files":
        navigate("/editor/my-files");
        break;
      default:
        break;
    }
    ...
    >
      ...
      <List>
        {[
          ...
          { text: "My Orders", icon: <Assignment /> },
          { text: "Chat", icon: <ChatIcon /> },
          { text: "My Writers", icon: <Edit /> },
    ...
    <Box sx={{ display: "flex", height: "100vh" }}>
      ...
      >
        <Toolbar>
          ...
          <Typography>Hello! {user ? user.name : "Editor"}</Typography>
        </Toolbar>
      </AppBar>
